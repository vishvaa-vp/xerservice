...
export const metadata: Metadata = {
    title: {
        default: 'Vendor HQ | XerService',
        template: '%s | XerService Vendor',
    },
    description: "XerService Vendor Portal. Manage real-time print orders, queues, shop availability, and revenue.",
    icons: {
        icon: [
